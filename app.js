...
function tone(start, duration) {
  ...
  gain.gain.linearRampToValueAtTime(0.24, start + RAMP_SECONDS);
  gain.gain.setValueAtTime(0.24, Math.max(start, start + duration - RAMP_SECONDS));
